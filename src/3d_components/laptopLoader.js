...
function Model(props) {
    ...
    useFrame((state, delta) => {
        ...
        group.current.rotation.x = THREE.MathUtils.lerp(group.current.rotation.x, props.beenInit ? Math.cos(t / 2) / 8 - 0.25 : 5, 0.1)
        ...
        group.current.position.x = THREE.MathUtils.lerp(group.current.position.x, !props.beenInit ? 0 : 35, 0.007)
        group.current.position.y = THREE.MathUtils.lerp(group.current.position.y, !props.beenInit ? -1 : 1, 0.007)
        group.current.position.z = THREE.MathUtils.lerp(group.current.position.z, !props.beenInit ? -3 : -75, 0.014)
        ...
        group.current.rotation.x = THREE.MathUtils.lerp(group.current.rotation.x, !props.beenInit ? 0.2 : Math.PI/2, 0.06)
    })
