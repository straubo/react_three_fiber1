        ...
        <div>
			...
			<div className='bioInner'>
				<div className='bioBody'>
					...
					Working almost exclusively on the Comcast Xfinity account for three years, Casey has helped push Xfinity's in-store experience into the 
					...
					spends time with his cat, Phoebe. 
				</div>
			</div>
        </div>
    )
