    ...
    return (
        <div>
			...
			<div className='bioInner'>
				...
				Currently, Casey works at Elephant, a creative company, as a senior creative technologist and front-end developer.
				Working almost exclusively on the Comcast account, Casey has helped push Xfinity's in-store experience into the 
				21st century using VR, AR and 3D web technologies for three years. Much of the R&D and prototyping Casey does lays the groundwork
				for in-store experiences, whether these be for the premiere and flagship stores or nationwide. For more information on Casey's work at Elephant,
				go to the Work page.
				{/* click here? */}
				<br></br><br></br>
